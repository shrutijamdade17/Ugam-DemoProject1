...
import com.ugamdemo.core.models.TestimonialMultifield;
...
@Model(
        ...
        adapters = TestimonialMultifield.class,
        defaultInjectionStrategy = DefaultInjectionStrategy.OPTIONAL
)

public class TestimonialMultifieldImple implements TestimonialMultifield {
    @ChildResource
